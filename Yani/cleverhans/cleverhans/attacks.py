...
class Attack(object):
    ...
    def __init__(self, model, back='tf', sess=None):
        ...
        if not isinstance(model, Model):
            ...
            print("The model argument should be an instance of"
                             " the cleverhans.model.Model class.")
    ...
    def construct_graph(self, fixed, feedable, x_val, hash_key):
        ...
        is_batch_size = 'batch_size' in fixed.keys()
        if is_batch_size:
    ...
    def generate_np(self, x_val, **kwargs):
        ...
        feed_dict = {x: x_val}#, K.learning_phase(): 0}
...
class FastGradientMethod(Attack):
    ...
    def __init__(self, model, back='tf', sess=None):
        ...
        self.feedable_kwargs = {'eps': np.float32,
                                ...
                                'clip_min': np.float32,
                                'clip_max': np.float32}
        self.structural_kwargs = ['ord', 'batch_size']
...
class BasicIterativeMethod(Attack):
    ...
    def __init__(self, model, back='tf', sess=None):
        ...
        self.feedable_kwargs = {'eps': np.float32,
                                ...
                                'clip_min': np.float32,
                                'clip_max': np.float32}
        self.structural_kwargs = ['ord', 'nb_iter', 'batch_size']
...
class MomentumIterativeMethod(Attack):
    ...
    def __init__(self, model, back='tf', sess=None):
        ...
        self.feedable_kwargs = {'eps': np.float32,
                                ...
                                'clip_min': np.float32,
                                'clip_max': np.float32}
        self.structural_kwargs = ['ord', 'nb_iter', 'decay_factor', 'batch_size']
...
class SaliencyMapMethod(Attack):
    ...
    def __init__(self, model, back='tf', sess=None):
        ...
        self.structural_kwargs = ['theta', 'gamma', 'batch_size',
...
class VirtualAdversarialMethod(Attack):
    ...
    def __init__(self, model, back='tf', sess=None):
        ...
        self.feedable_kwargs = {'eps': tf.float32, 'xi': tf.float32,
                                'clip_min': tf.float32,
                                'clip_max': tf.float32}
        self.structural_kwargs = ['num_iterations', 'batch_size']
...
class DeepFool(Attack):
    ...
    def __init__(self, model, back='tf', sess=None):
        ...
        self.structural_kwargs = ['over_shoot', 'max_iter', 'clip_max',
                                  'clip_min', 'nb_candidate', 'batch_size']
